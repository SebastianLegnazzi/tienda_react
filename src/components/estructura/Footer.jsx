        ...
        return (
            <footer className="d-flex flex-wrap justify-content-between align-items-center py-3 px-5">
                ...
                <ul className="nav justify-content-end flex-column col-3,5">
                    <li className="nav-item"><a href="https://github.com/SebastianLegnazzi/tienda_react" target='_blank' className="nav-link px-2 text-white"><span> Legnazzi Sebastian Nicolas</span></a></li>
                </ul>
            </footer>
        )
    }
